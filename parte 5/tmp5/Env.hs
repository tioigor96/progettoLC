...
op2CompType LtO (Base BasicType_Bool) (Base BasicType_Bool)          = (Base BasicType_Bool)
...
op2CompType LtEO (Base BasicType_Bool) (Base BasicType_Bool)          = (Base BasicType_Bool)
...
op2CompType GtO (Base BasicType_Bool) (Base BasicType_Bool)          = (Base BasicType_Bool)
...
op2CompType GtEO (Base BasicType_Bool) (Base BasicType_Bool)          = (Base BasicType_Bool)
