...
instance Print AbsAuL.Stm where
  prt i e = case e of
    ...
    AbsAuL.SRExp rexp -> prPrec i 0 (concatD [prt 0 rexp, doc (showString ";")])
...
instance Print AbsAuL.While where
  prt i e = case e of
    AbsAuL.LoopW rexp block -> prPrec i 0 (concatD [doc (showString "while"), prt 0 rexp, doc (showString "do"), prt 0 block, doc (showString "end")])
...
instance Print AbsAuL.For where
  prt i e = case e of
    AbsAuL.LoopF lident rexp1 rexp2 increment block -> prPrec i 0 (concatD [doc (showString "for"), prt 0 lident, doc (showString "="), prt 0 rexp1, doc (showString ","), prt 0 rexp2, prt 0 increment, doc (showString "do"), prt 0 block, doc (showString "end")])
    AbsAuL.LoopFE lident1 lident2 block -> prPrec i 0 (concatD [doc (showString "for"), prt 0 lident1, doc (showString "in"), prt 0 lident2, doc (showString "do"), prt 0 block, doc (showString "end")])
...
instance Print AbsAuL.FuncD where
  prt i e = case e of
    AbsAuL.FnctDecl basictype lident paramfs block -> prPrec i 0 (concatD [prt 0 basictype, doc (showString "function"), prt 0 lident, doc (showString "("), prt 0 paramfs, doc (showString ")"), prt 0 block, doc (showString "end")])
...
instance Print AbsAuL.RExp where
  prt i e = case e of
    ...
    AbsAuL.ValMArr array -> prPrec i 12 (concatD [doc (showString "{"), prt 0 array, doc (showString "}")])
  prtList _ [] = concatD []
  prtList _ [x] = concatD [prt 0 x]
  prtList _ (x:xs) = concatD [prt 0 x, doc (showString ","), prt 0 xs]
...
instance Print AbsAuL.Array where
  prt i e = case e of
    AbsAuL.ArrayV0 array1 array2 -> prPrec i 0 (concatD [doc (showString "{"), prt 0 array1, doc (showString "}"), doc (showString ","), prt 0 array2])
    AbsAuL.ArrayV1 array -> prPrec i 0 (concatD [doc (showString "{"), prt 0 array, doc (showString "}")])
    AbsAuL.ArrayV2 vtypes -> prPrec i 0 (concatD [prt 0 vtypes])
...
instance Print AbsAuL.VType where
  prt i e = case e of
    ...
    AbsAuL.VType1 -> prPrec i 0 (concatD [])
  prtList _ [x] = concatD [prt 0 x]
  prtList _ (x:xs) = concatD [prt 0 x, doc (showString ","), prt 0 xs]
