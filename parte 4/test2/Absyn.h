...
struct Import_ {
    ...
    union {
        struct {
            ListCS listcs_1, listcs_2, listcs_3, listcs_4, listcs_5;
            NameFile namefile_;
            S s_;
        } imp_;
    } u;
...
struct SectionP_ {
    ...
    union {
        struct {
            Fields fields_;
            ListCS listcs_1, listcs_2, listcs_3, listcs_4, listcs_5, listcs_6;
...
struct Fields_ {
    ...
    union {
        struct {
            FieldT fieldt_;
            ListCS listcs_1, listcs_2, listcs_3, listcs_4, listcs_5, listcs_6, listcs_7, listcs_8;
...
Fields
make_Fld(ListCS p0, ListCS p1, ListCS p2, NameField p3, ListCS p4, ListCS p5, Value p6, ListCS p7, ListCS p8, ListCS p9,
         FieldT p10);
...
struct FieldT_ {
    ...
    union {
        ...
        struct {
            ListCS listcs_1, listcs_2, listcs_3;
            SectionF sectionf_;
        } fldts_;
    } u;
};
...
struct Value_ {
    enum {
        is_Val, is_ValI, is_ValD, is_ValB, is_ValV, is_ValG
    } kind;
    union {
        struct {
            String string_;
        ...
        struct {
            VariableLocal variablelocal_;
        } valv_;
        struct {
            VariableGlobal variableglobal_;
        } valg_;
    } u;
};
