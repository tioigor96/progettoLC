...
data HappyAbsSyn 
	...
	| HappyAbsSyn6 (TreeLex)
	| HappyAbsSyn7 ([TreeLex])
...
action_0,
 ...
 action_10,
 action_11,
 action_12 :: () => Int -> ({-HappyReduction (Err) = -}
	   Int 
	-> (Token)
...
happyReduce_2,
 ...
 happyReduce_4,
 happyReduce_5,
 happyReduce_6 :: () => ({-HappyReduction (Err) = -}
	   Int 
	-> (Token)
	-> HappyState (Token) (HappyStk HappyAbsSyn -> [(Token)] -> (Err) HappyAbsSyn)
	-> [HappyState (Token) (HappyStk HappyAbsSyn -> [(Token)] -> (Err) HappyAbsSyn)] 
...
happyReduction_3 (_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn6
		 (AbsBNF.TreeL happy_var_1 happy_var_3
	) `HappyStk` happyRest

happyReduce_4 = happySpecReduce_1  6 happyReduction_4
happyReduction_4 (HappyAbsSyn5  happy_var_1)
	 =  HappyAbsSyn6
		 (AbsBNF.LeafL happy_var_1
	)
