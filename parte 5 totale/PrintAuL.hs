...
instance Print AbsAuL.RExp where
  prt i e = case e of
    ...
    AbsAuL.Eq rexp1 rexp2 -> prPrec i 3 (concatD [prt 5 rexp1, doc (showString "=="), prt 5 rexp2])
    AbsAuL.Neq rexp1 rexp2 -> prPrec i 3 (concatD [prt 5 rexp1, doc (showString "~="), prt 5 rexp2])
    AbsAuL.Lt rexp1 rexp2 -> prPrec i 3 (concatD [prt 5 rexp1, doc (showString "<"), prt 5 rexp2])
    AbsAuL.LtE rexp1 rexp2 -> prPrec i 3 (concatD [prt 5 rexp1, doc (showString "<="), prt 5 rexp2])
    AbsAuL.Gt rexp1 rexp2 -> prPrec i 3 (concatD [prt 5 rexp1, doc (showString ">"), prt 5 rexp2])
    AbsAuL.GtE rexp1 rexp2 -> prPrec i 3 (concatD [prt 5 rexp1, doc (showString ">="), prt 5 rexp2])
